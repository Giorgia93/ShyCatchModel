...
def main():
    ...
    scenario_results = np.empty((nsims, 6, n_scenarios))
    ...
    for iscen in np.arange(n_scenarios):
        ...
        scenario_results[:, :, iscen] = np.transpose([t_erad, erad_bool, N_final, 
    ...
    # scenarios_results_file = "../results/scenarios_20230928"
    # np.save(scenarios_results_file, scenario_results)
    
    # Load scenario results and plot heatmaps to compare them 
    scenarios_results_file = "../results/scenarios_20230928"
